...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, puppeteer.launch({ headless: false, slowMo: 40 })];
            case 1:
                browser = _a.sent();
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, page.goto('http://localhost:8083/')];
            case 4:
                _a.sent();
                //await page.waitFor(2000); // nie stosować bez wyraźnej potrzeby! Użyte ze względu na długi czas doczytywania notatek
                return [4 /*yield*/, page.screenshot({ path: 'screen.png' })];
            case 5:
                //await page.waitFor(2000); // nie stosować bez wyraźnej potrzeby! Użyte ze względu na długi czas doczytywania notatek
                _a.sent();
                return [4 /*yield*/, page.waitForSelector('#blue')];
            case 6:
                _a.sent();
                return [4 /*yield*/, page.type('#title', 'Puppeteer')];
            case 7:
                _a.sent();
                return [4 /*yield*/, page.type('#body', 'is working')];
            case 8:
                _a.sent();
                return [4 /*yield*/, page.keyboard.press('Enter')];
            case 9:
                _a.sent();
                return [4 /*yield*/, page.screenshot({ path: 'screen-after-wait.png' })];
            case 10:
                _a.sent();
                return [2 /*return*/];
        }
